  ...
  computed: {
    ...
    txMineList() {
      return this.vxMineInfo && this.minePool && [{
        ...
        precentAmount: this.minePool['VITE'] && (this.minePool['VITE'].btcFee / (this.minePool['VITE'].btcFee /this.allMineBtcFee() * this.formatVX(this.vxMineInfo.feeMineDetail['1']))).toFixed(8)
      }, {
        tokenSymbol: 'BTC',
        ...
        precentAmount: this.minePool['BTC'] && (this.minePool['BTC'].btcFee / (this.minePool['BTC'].btcFee /this.allMineBtcFee() * this.formatVX(this.vxMineInfo.feeMineDetail['2']))).toFixed(8)
      }, {
        tokenSymbol: 'ETH',
        ...
        precentAmount: this.minePool['ETH'] && (this.minePool['ETH'].btcFee / (this.minePool['ETH'].btcFee /this.allMineBtcFee() * this.formatVX(this.vxMineInfo.feeMineDetail['3']))).toFixed(8)
      }, {
        tokenSymbol: 'USDT',
        ...
        precentAmount: this.minePool['USDT'] && (this.minePool['USDT'].btcFee / (this.minePool['USDT'].btcFee /this.allMineBtcFee() * this.formatVX(this.vxMineInfo.feeMineDetail['4']))).toFixed(8)
      }] || [];
    },
    orderMineList() {
