...
import { httpServicesMap, wsServicesMap } from '~/utils/proto/subService';
...
Vue.prototype.$subTask = (key, callback) => {
  return new subTask(key, callback);
};
